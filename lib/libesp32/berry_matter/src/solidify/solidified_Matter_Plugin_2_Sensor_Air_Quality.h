...
be_local_class(Matter_Plugin_Sensor_Air_Quality,
    ...
    ( (struct bmapnode*) &(const bmapnode[]) {
        ...
        be_const_map( *     be_nested_map(11,
    ( (struct bmapnode*) &(const bmapnode[]) {
        { be_const_key_int(91, 5), be_const_bytes_instance(0000FFF8FFF9FFFAFFFBFFFCFFFD) },
        { be_const_key_int(1068, -1), be_const_bytes_instance(00000001000200080009FFF8FFF9FFFAFFFBFFFCFFFD) },
        { be_const_key_int(1069, 6), be_const_bytes_instance(00000001000200080009FFF8FFF9FFFAFFFBFFFCFFFD) },
        { be_const_key_int(1070, 8), be_const_bytes_instance(00000001000200080009FFF8FFF9FFFAFFFBFFFCFFFD) },
        ...
        { be_const_key_int(1037, 0), be_const_bytes_instance(00000001000200080009FFF8FFF9FFFAFFFBFFFCFFFD) },
