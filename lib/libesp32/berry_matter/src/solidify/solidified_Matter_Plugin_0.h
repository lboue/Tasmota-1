...
be_local_class(Matter_Plugin,
    ...
    ( (struct bmapnode*) &(const bmapnode[]) {
        ...
        be_const_map( *     be_nested_map(24,
    ( (struct bmapnode*) &(const bmapnode[]) {
        { be_const_key_int(768, 2), be_const_int(6) },
        { be_const_key_int(769, -1), be_const_int(4) },
        { be_const_key_int(1032, -1), be_const_int(3) },
        { be_const_key_int(3, -1), be_const_int(4) },
        ...
        { be_const_key_int(512, 11), be_const_int(4) },
        { be_const_key_int(513, -1), be_const_int(6) },
        { be_const_key_int(514, -1), be_const_int(4) },
        { be_const_key_int(56, 7), be_const_int(2) },
        ...
        { be_const_key_int(258, 14), be_const_int(5) },
